...
<head>
  ...
  <script type="text/javascript">
    function show_confirm(action, gotoid) {
      ...
      if (conf==true){
        window.location="<?php echo base_url();?>categories/"+action+"/"+gotoid;
      }
    }
  </script>
</head>
<body>
  ...
  <tr>
    ...
    <td width="40" align="left" ><a href=<?php echo base_url().'categories/edit/'.$row->id; ?> >Edit</a></td>
    <td width="40" align="left" ><a href="#" onClick="show_confirm('delete',<?php echo $row->id;?>)">Delete</a></td>
  </tr>
  <?php 
  } 
  ?>
  <td colspan="7" align="right"> <a href=<?php echo base_url().'categories/add_form/'.$row->id;?> >Add New Category</a></td>
</table>
